...
Every human review decision made while running the content pipeline, in order.
...
## 2026-07-27 15:34
- Topic: customer support chatbots
- Content type: linkedin_post
- Decision: edit_requested
- Feedback: add more reasons
